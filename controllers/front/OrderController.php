        ...
        switch ((int)$this->step) {
            ...
            case OrderController::STEP_ADDRESSES:
                ...
                if (Tools::getValue('multi-shipping') == 1) {
                    ...
                    $this->setTemplate('order-address-multishipping.tpl');
                } else {
                    $this->setTemplate('order-address.tpl');
                }
            break;
            ...
            case OrderController::STEP_DELIVERY:
                ...
                $this->autoStep();
                $this->_assignCarrier();
                $this->setTemplate('order-carrier.tpl');
            break;
            ...
            case OrderController::STEP_PAYMENT:
                ...
                $this->_assignSummaryInformations();
                $this->setTemplate('order-payment.tpl');
            break;
