...
<div id="order-detail-content" class="table_block table-responsive">
    <table id="cart_summary" class="table table-bordered {if $PS_STOCK_MANAGEMENT}stock-management-on{else}stock-management-off{/if}">
        ...
        {foreach $products as $product}
            ...
            {include file="partials/shopping-cart-product-line.tpl" productLast=$product@last productFirst=$product@first noDeleteButton=1 cannotModify=1}
            ...
            {if isset($customizedDatas.$productId.$productAttributeId)}
                ...
                {if $product.quantity-$quantityDisplayed > 0}{include file="partials/shopping-cart-product-line.tpl" productLast=$product@last productFirst=$product@first noDeleteButton=1 cannotModify=1}{/if}
            {/if}
        {/foreach}
